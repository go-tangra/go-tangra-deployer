...
// The deployer UI is a federated remote served by the module under /ui/ and
// relayed by the gateway at /m/deployer/; `vite` alone runs a standalone dev
...
export default defineConfig({
  ...
  test: {
    environment: 'jsdom',
    environmentOptions: { jsdom: { url: 'https://localhost/deployer' } },
