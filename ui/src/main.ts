// Standalone development entry: mounts the deployer routes in a bare kit shell
...
const app = createApp({ render: () => h(UiAppShell, { title: 'deployer (dev)', hideNav: true }, () => h(RouterView)) })
app.use(createPinia())
