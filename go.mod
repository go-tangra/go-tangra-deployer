module github.com/go-tangra/go-tangra-deployer
...
require (
	...
	github.com/go-tangra/go-tangra-common v1.18.0
	github.com/go-tangra/go-tangra-lcm v1.5.1-0.20260520080815-79a8b5d92fbd
